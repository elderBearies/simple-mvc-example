...
let lastAddedCat = new Cat(defaultCat);
...
const findDogByName = (req, res) => {
  ...
  return Dog.findByName(req.query.name, (err, doc) => {
    ...
    const savePromise = upDog.save();

    savePromise.then(() => res.json({ name: upDog.name, breed: upDog.breed, age: upDog.age }));
